...
- _SVG/Canvas a mano_ → control total, pero mucho tiempo y bugs de interacción.
- _Cytoscape.js / vis.js_ → potentes pero menos idiomáticas en React y con estética
