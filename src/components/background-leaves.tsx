...
const LEAVES: BgLeaf[] = [
  { x: 6, y: 18, size: 14, rot: -18, op: 0.1, dur: 12, delay: 0, tint: "#3f9b57" },
  { x: 15, y: 68, size: 11, rot: 24, op: 0.08, dur: 15, delay: 4, tint: "#4ea85f" },
  { x: 24, y: 38, size: 9, rot: 40, op: 0.07, dur: 13, delay: 8, tint: "#68b97a" },
  { x: 34, y: 82, size: 13, rot: -30, op: 0.09, dur: 16, delay: 2, tint: "#3f9b57" },
  { x: 44, y: 12, size: 10, rot: 10, op: 0.08, dur: 14, delay: 6, tint: "#4ea85f" },
  { x: 52, y: 60, size: 12, rot: -12, op: 0.09, dur: 11, delay: 9, tint: "#2f8f52" },
  { x: 62, y: 28, size: 9, rot: 32, op: 0.07, dur: 17, delay: 3, tint: "#68b97a" },
  { x: 71, y: 74, size: 14, rot: -22, op: 0.1, dur: 13, delay: 7, tint: "#3f9b57" },
  { x: 80, y: 44, size: 11, rot: 18, op: 0.08, dur: 15, delay: 1, tint: "#4ea85f" },
  { x: 88, y: 20, size: 10, rot: -36, op: 0.08, dur: 12, delay: 5, tint: "#2f8f52" },
  { x: 92, y: 66, size: 12, rot: 26, op: 0.09, dur: 16, delay: 10, tint: "#3f9b57" },
  { x: 40, y: 92, size: 9, rot: -8, op: 0.07, dur: 14, delay: 12, tint: "#68b97a" },
];
